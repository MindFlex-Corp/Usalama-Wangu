...
> = {
  ...
  wildlife_danger: {
    fillColor: "rgba(255, 215, 0, 0.25)", // Changed from green to gold
    strokeColor: "#FFD700", // Changed from green to gold
    strokeWidth: 2,
    shouldBlink: true,
    markerEmoji: "🦁",
  },
...
export default function App() {
  ...
  const renderZoneMarker = (zone: Zone) => {
    ...
    // Wildlife danger marker - NOW WITH GOLD BACKGROUND
    if (zone.type === "wildlife_danger") {
      return (
        <Marker
          ...
          description={descriptionWithTime}
        >
          <View style={styles.wildlifeMarker}>
...
const styles = StyleSheet.create({
  ...
  wildlifeIcon: {
    backgroundColor: "#FFD700", // Gold instead of green
    borderRadius: 20,
    width: 40,
    height: 40,
    alignItems: "center",
